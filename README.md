Simple Console APP that searches for all the TIA Portal (Detects the version Installed on the system, only support for one at a time at the moment) projects 
